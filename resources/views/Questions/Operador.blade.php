                          ...
                          <div class="container">
                                  ...
                                  <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                                    <div class="panel panel-default">
                                      ...
                                      <textarea class="form-control" name="NForm" id="NForm" rows="1"></textarea>
                                      <textarea class="form-control" name="Duracion" id="Duracion" rows="1" cols="10"></textarea>
                                               <input type="submit" name="crear-form" value="Login">
                                        </form>
