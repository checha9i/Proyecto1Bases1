...
<div class="container">
  ...
  <form  id="myForm" role="form" action="/AgregarPregunta" method="post">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">

  <p>Crear Pregunta</p>

  <input type="text" name="pregunta" id="pregunta" class="form-control" placeholder=""><br/>
 ...
 <input type="submit" name="crear-form" value="AgregarPregunta">
</form>
